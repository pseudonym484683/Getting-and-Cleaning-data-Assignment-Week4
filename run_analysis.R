## Read given data sets and combine
testData <- read.table("test/X_test.txt")
trainData <- read.table("train/X_train.txt")
X <- rbind(testData, trainData)

## Trigger Garbage collection or test data and training data
rm(testData)
rm(trainData)
...
## Trigger Garbage collection or test data and training data subject
rm(testSub)
rm(trainSub)
...
## Trigger Garbage collection or test data and training data label
rm(testLabel)
rm(trainLabel)
